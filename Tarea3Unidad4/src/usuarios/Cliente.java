...
public class Cliente extends Usuario{
    ...
    public Cliente(String nombre, String apellido,  String numeroTelefono, String nombreUsuario, String contrasena, String fechaNacimiento){
        super(nombre, apellido, Rol.CLIENTE, numeroTelefono, nombreUsuario, contrasena, fechaNacimiento);
    ...
    public String toString(){
        return String.format("%s \nFecha de registro: %s\n\n", super.toString(), getFechaRegistro());}
