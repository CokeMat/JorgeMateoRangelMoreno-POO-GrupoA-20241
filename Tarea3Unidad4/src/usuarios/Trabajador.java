...
public class Trabajador extends Usuario implements EmpleadoUtils {
    ...
    public Trabajador(String nombre, String apellido, int edad, String departamento, String numeroTelefono, String nombreUsuario, String contrasena, String fechaNacimiento) {
        super(nombre, apellido, Rol.TRABAJADOR, numeroTelefono, nombreUsuario, contrasena, fechaNacimiento);
        this.edad=edad;
    ...
    public String toString(){
        return String.format("%s \nEdad: %d \nsalario: $%.2f \nDepartamento: %s \nFecha de Registro: %s \n\n", super.toString(), getEdad(), getSalario(), getDepartamento(), getFechaRegistro());
    }
    ...
    public static void addTrabajadores(){
        ...
        Trabajador trabajador = new Trabajador(nombre, apellido, edad, departamente, telefono, nombreUsuario, contrasena, fechaNacimiento);
