...
public abstract class Libro {
    ...
    public Libro(String nombre, String autor, String editorial, String fechaPublicacion, double precio,
    ...
    protected abstract void filtrarPorFecha(String Fecha);
    ...
    protected void filtrarPorGenero(Genero genero){
        Biblioteca.libros.get(genero.toString()).stream().filter(libro -> libro.getGenero() == genero).forEach(libro -> System.out.println(libro.toString()));
    }
